    ...
    return (
        <>
            ...
            <div className="mb-3">
                ...
                <textarea style={{fontFamily:font}} className="form-control bg-info " id="inputText" rows="10" value={text}  onChange={entrVal}></textarea>
            </div>
            <div className="d-flex p-2">
                <Button title="Caps on" btnFunc={cvrtCaps} classProps="btn btn-danger m-1 rounded-pill" />
                <Button title="Caps off" btnFunc={cvrtLowCaps} classProps="btn btn-warning m-1 rounded-pill" />
